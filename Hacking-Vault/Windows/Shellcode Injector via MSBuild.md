...
Via MSBuild it will download and execute.
 ...
 ⚠ If you are using Cobalt Strike,  you can use `http_x64.xprocess.bin` here and host it on the Cobalt Strike Team Server via _Site Management > Host File_.
